...
| **RF09** | **Gerador de PDF de Laudo** | O sistema deverá gerar um arquivo PDF sob demanda contendo os dados do laudo da carta para exportação e impressão formal do colecionador. | Média | Pendente |
